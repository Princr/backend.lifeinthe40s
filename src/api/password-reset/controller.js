...
export const create = ({ bodymen: { body: { email, link } } }, res, next) =>
  User.findOne({ email })
    ...
    .then((reset) => {
      ...
      const content = `
        Hey, ${user.name}.<br><br>
        You requested a new password for your Backend Lifeinthe 40 S account.<br>
        ...
        &mdash; Backend Lifeinthe 40 S Team
      `
      return sendMail({ toEmail: email, subject: 'Backend Lifeinthe 40 S - Password Reset', content })
    })
